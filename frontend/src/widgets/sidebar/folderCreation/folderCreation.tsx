...
export const FolderCreation: FC<FolderCreationProps> = ({
	...
	return (
		<div
			key={'folder-creation-button-container'}
			...
			alignItems:'center',
				...
				>
					<div
						key={'folder-creation-menu-modal'} 
						style={{
						display: 'flex',
						...
						<Typography key={'folder-title-text'} fontSize={'var(--ft-body)'}>Folder name</Typography>
						{
							resp.isError
							? <Typography
