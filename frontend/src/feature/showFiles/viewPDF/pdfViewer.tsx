 ...
 * @returns 
 */
export const ViewPDF: FC<ViewPDFProps> = React.memo(function viewPdf({ pdfURL, openPageInPDF, authToken }: ViewPDFProps) {
	...
	return < PdfUrlViewer url={pdfURL} authToken={authToken} page={openPageInPDF} />
});
